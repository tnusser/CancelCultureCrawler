...
event_list = [
    ...
    #             username=None, comment="", days=1100),
    EventSearch(uid="e31", tweet_id=None, start_date="2021-01-15T01:00:00.000Z", tag_and_mention={"#BoycottMyPillow", "#CancelMyPillow", "#CancelMikeLindell", "#MikeLindell"},
                username=None, comment="Mike Lindell", days=31),
    EventSearch(uid="e32", tweet_id=None, start_date="2021-02-10T01:00:00.000Z", tag_and_mention={"#FireChrisHarrison", "#CancelChrisHarrison", "#ChrisHarrison", "#istandwithrachel", "#thebachelor"},
                username=None, comment="Chris Harrison", days=31),
    EventSearch(uid="e33", tweet_id=None, start_date="2021-02-28T01:00:00.000Z", tag_and_mention={"#BoycottGoya", "#BoycottGoyaFoods", "@GoyaFoods"},
