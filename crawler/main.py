...
event_list = [
    ...
    #            username=None, comment="", days=1100),
    EventSearch(uid="e31", tweet_id=None, start_date="2021-01-15T01:00:00.000Z",
                tag_and_mention={"#BoycottMyPillow", "#CancelMyPillow", "#CancelMikeLindell", "#MikeLindell"},
                username=None, comment="Mike Lindell", days=31),
    EventSearch(uid="e32", tweet_id=None, start_date="2021-02-10T01:00:00.000Z",
                tag_and_mention={"#FireChrisHarrison", "#CancelChrisHarrison", "#ChrisHarrison", "#istandwithrachel"},
                username=None, comment="Chris Harrison", days=31),
    EventSearch(uid="e33", tweet_id=None, start_date="2021-02-28T01:00:00.000Z",
                tag_and_mention={"#BoycottGoya", "#BoycottGoyaFoods", "@GoyaFoods"},
                username=None, comment="Goya Foods", days=14),
    EventSearch(uid="e34", tweet_id=None, start_date="2021-10-04T23:00:00.000Z",
                tag_and_mention={"#DaveChappelle", "#CancelDaveChappelle", "#CancelNetflix", "@DaveChappelle"},
                username=None, comment="Dave Chappelle", days=14),
    ...
    EventSearch(uid="e36", tweet_id=None, start_date="2018-01-01T01:00:00.000Z", tag_and_mention={"#FlagrantFreddie"},
                username=None, comment="", days=1100),
    EventSearch(uid="e37", tweet_id=None, start_date="2018-05-29T01:00:00.000Z",
